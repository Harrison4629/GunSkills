...
import com.moon404.gunskills.mobeffect.Charge;
...
public class GunSkillsEffects
{
    ...
    public static final RegistryObject<MobEffect> CHARGE = REGISTER.register("charge", () -> new Charge(MobEffectCategory.BENEFICIAL, 0x55FF55));
}
